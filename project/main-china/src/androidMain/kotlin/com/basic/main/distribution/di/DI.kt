/**
 * @Description: main 模块 China 发行渠道公共能力的 Koin 注册定义。
 * @Author:         fanjun
...
import com.basic.main.distribution.di.impl.ChinaMainDistributionServiceImpl
import com.basic.main.di.service.MainDistributionService
import org.koin.dsl.module

/** main 模块 China 发行渠道公共能力的 Koin 模块。 */
val mainDistributionModule = module {
    registerSPI<ApplicationService> { ApplicationServiceImpl() }
    registerSPI<MainDistributionService> { ChinaMainDistributionServiceImpl() }
}
