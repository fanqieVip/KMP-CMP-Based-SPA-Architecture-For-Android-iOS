...
fun Settings.asFlowInt(key: String, initialValue: Int? = null) = object : DataStoreFlow<Int>(sets = this, key = key, initialValue) {
...
fun Settings.asFlowDouble(key: String, initialValue: Double? = null) = object : DataStoreFlow<Double>(sets = this, key = key, initialValue) {
...
fun Settings.asFlowString(key: String, initialValue: String? = null) = object : DataStoreFlow<String>(sets = this, key = key, initialValue) {
...
fun Settings.asFlowBoolean(key: String, initialValue: Boolean? = null) = object : DataStoreFlow<Boolean>(sets = this, key = key, initialValue) {
...
fun Settings.asFlowFloat(key: String, initialValue: Float? = null) = object : DataStoreFlow<Float>(sets = this, key = key, initialValue) {
...
fun Settings.asFlowLong(key: String, initialValue: Long? = null) = object : DataStoreFlow<Long>(sets = this, key = key, initialValue) {
...
inline fun <reified T : Any> Settings.asFlowJson(key: String, initialValue: T? = null) = DataStoreFlowJson(
    sets = this, key = key, initialValue = initialValue, deserializer = T::class.serializer()
)
