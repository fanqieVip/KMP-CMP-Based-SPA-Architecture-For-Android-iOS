...
import com.basic.common.distribution.di.impl.ChinaCommonDistributionServiceImpl
...
val commonDistributionModule = module {
    ...
    registerSPI<CommonDistributionService> { ChinaCommonDistributionServiceImpl() }
}
