...
class IosCommonDistributionServiceImpl : CommonDistributionService {
    ...
    private companion object {
        /** IDFA 缓存键。 */
        const val CACHE_IOS_IDFA_KEY = "com.basic.base/CACHE_IOS_IDFA_KEY"

        /** IDFV 缓存键。 */
        const val CACHE_IOS_IDFV_KEY = "com.basic.base/CACHE_IOS_IDFV_KEY"

        /** Keychain 标识缓存键。 */
        const val CACHE_IOS_KEYCHAIN_KEY = "com.basic.base/CACHE_IOS_KEYCHAINKEY"

        /** IDFA 授权状态缓存键。 */
        const val CACHE_IOS_IS_AGREE_IDFA = "com.basic.base/CACHE_IOS_IS_AGREE_IDFA"

        /** 是否已请求过 IDFA 授权的缓存键。 */
        const val CACHE_IOS_HAS_APPLY_IDFA = "com.basic.base/CACHE_IOS_HAS_APPLY_IDFA"
    }
}
